...
export const getRefundPage = (params: RefundPageReqVO) => {
  return request.post({ url: '/oil/refund/refundPage', data: params })
}
...
export const auditRefund = (data: any) => {
  return request.post({ url: `oil/refund/check`, data })
}
...
export const exportRefund = (params: PayRefundExportReqVO) => {
  return request.download({ url: '/oil/refund/export-excel', params })
}
