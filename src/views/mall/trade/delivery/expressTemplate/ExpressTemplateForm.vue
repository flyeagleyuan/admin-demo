  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1300px">
    ...
    >
      <el-form-item label="模板名称" prop="name">
        <el-input v-model="formData.name" placeholder="请输入模板名称" ref="addName"/> 
      </el-form-item>
      <el-form-item label="计费方式" prop="chargeMode">
        <el-radio-group v-model="formData.chargeMode" @change="changeChargeMode" ref="addCode">
          <el-radio
      ...
      <el-form-item label="排序" prop="sort">
        <el-input-number v-model="formData.sort" controls-position="right" :min="0" ref="addSort"/>
      </el-form-item>
    </el-form>
    <template #footer>
